...
class Ui_ProjeDialog(object):
    def setupUi(self, ProjeDialog):
        ...
        self.label_projeayi.setText("Proje Ayı/Yılı (YYYYAA):")
        ...
        self.lineEdit_projeayi.setPlaceholderText("Örn: 202312")
        ...
        self.label_fark_yaklasik_teklif.setText("Kırım Oranı (%0.00)") # Bu satır güncellendi
        ...
        self.label_fark_teklif_gercek.setText("Teklif - Gerçek Maliyet Farkı: 0.00 TL (%0.00)")
